    ...
    <section className={styles.heroContainer}>
      <div className={styles.textCenter}>
        <h1 className={styles.heading}>
          ...
          <br />
          You need <span className={styles.highlight}>marketing</span>.
        </h1>
        <p className={`${styles.textLg} ${styles.textGray600}`}>
          Get a 100% customised marketing plan on how to get more users and grow your SaaS, with ROI projection.
        </p>
        <motion.div
          ...
          className="mt-8"
        >
          <Link href="/get-report" className={styles.btnPrimary}>
            Get your report — in 5 minutes!
          </Link>
        </motion.div>
        <div className="mt-4">
          <span className={styles.textYellow500}>⭐️⭐️⭐️⭐️⭐️</span> 200+ founders grew faster
        </div>
      </div>
    </section>
  );
